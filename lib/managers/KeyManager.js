...
function KeyManager () {
  ...
  if (settings.spectatorMode) {
    console.log('Press "1 2 3 4..." to change to the active camera or 0 to headset camera');
    console.log('Press Y or N to force sad or happy end when you has white magic');
  }
...
function onDocumentKeyDown (event) {
  ...
  switch (event.keyCode) {
    ...
    case 76: // l
      ...
      break;
    case 89: // y
      Events.emit('forceSadEnding', true);
      break;
    case 78: // n
