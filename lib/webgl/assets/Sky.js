...
Sky.prototype.update = function (delta, time) {
  ...
  if (this.isSkyStorming) {
    this.material.uniforms.colorTop.value = new THREE.Color(MathUtils.blendColors(0x999999, 0xffffff, this.thunder));
    this.material.uniforms.colorBottom.value = new THREE.Color(MathUtils.blendColors(0xffffff, 0x4bb8dd, this.thunder));
    this.scene.fog.color = new THREE.Color(MathUtils.blendColors(0xffffff, 0x4bb8dd, this.thunder));
    return;
  }
  if (this.isSkyFading) {
