...
function Minerals (initCuadrant) {
  ...
  var mineral = new Mineral(this, group1Handler, i, new THREE.Vector3(-0.1, 0, -0.3), 0.04);
  this.creaturesArr.push(mineral.mesh);
  mineral.mouth.scale.x = 0.5;
  this.add(mineral);
  mineral = new Mineral(this, group1Handler, i, new THREE.Vector3(-0.1, 0, -0.2), 0.04);
  this.creaturesArr.push(mineral.mesh);
  mineral.mouth.scale.x = 0.5;
  this.add(mineral);
  mineral = new Mineral(this, group1Handler, i, new THREE.Vector3(-0.1, 0, -0.1), 0.04);
  this.creaturesArr.push(mineral.mesh);
  mineral.mouth.scale.x = 0.5;
  this.add(mineral);

  // Add creatures of group 2
  mineral = new Mineral(this, group2Handler, i, new THREE.Vector3(-0.1, 0, 0.4), 0.03);
  this.creaturesArr.push(mineral.mesh);
  this.add(mineral);
  mineral = new Mineral(this, group2Handler, i, new THREE.Vector3(-0.1, 0, 0.3), 0.03);
  this.creaturesArr.push(mineral.mesh);
  this.add(mineral);
  mineral = new Mineral(this, group2Handler, i, new THREE.Vector3(-0.1, 0, 0.2), 0.03);
  this.creaturesArr.push(mineral.mesh);
  this.add(mineral);
}
