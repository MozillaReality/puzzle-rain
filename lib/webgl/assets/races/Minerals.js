...
function Minerals (pos) {
  ...
  var mineral = new Mineral(this, 1, new THREE.Vector3(-0.3, 0, -0.1).add(this.raceMesh.position), 0.06);
  this.creaturesArr.push(mineral);
  this.add(mineral);

  mineral = new Mineral(this, 2, new THREE.Vector3(-0.1, 0, 0.2).add(this.raceMesh.position), 0.08);
  this.creaturesArr.push(mineral);
  this.add(mineral);
...
Minerals.prototype.addEmitter = function () {
  ...
  this.emitter.setTranslation(0, 0, 0.1);
