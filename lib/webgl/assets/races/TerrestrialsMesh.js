...
function TerrestrialsMesh (obj) {
  ...
  var self = this;
  this.mesh.load('models/races/terrestrials.json', function () {
    ...
    self.mesh.material = new THREE.MeshStandardMaterial({
      ...
      roughness: 1,
      metalness: 0,
      emissive: new THREE.Color(settings[self.raceObj.name + 'Color']),
      emissiveIntensity: 0,
...
TerrestrialsMesh.prototype = Object.create(THREE.Object3D.prototype);

TerrestrialsMesh.prototype.update = function (delta) {
...
module.exports = TerrestrialsMesh;
