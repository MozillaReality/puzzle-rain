...
function Terrestrials (pos) {
  ...
  var terrestrial = new Terrestrial(this, 1, new THREE.Vector3(0, 0, 0), 0.4, 0.7, 1.3);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  terrestrial = new Terrestrial(this, 2, new THREE.Vector3(0.5, 0, 0.2), 0.3, 0.6, 1.2);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  terrestrial = new Terrestrial(this, 3, new THREE.Vector3(-0.5, 0, -0.2), 0.2, 0.5, 1.1);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
