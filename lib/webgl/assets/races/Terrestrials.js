...
function Terrestrials (pos) {
  ...
  var terrestrial = new Terrestrial(this, 1, new THREE.Vector3(0, 0, 0), 0.1, 0.7, 2.1);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  terrestrial = new Terrestrial(this, 2, new THREE.Vector3(0.5, 0, 0.2), 0.08, 0.6, 2);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  terrestrial = new Terrestrial(this, 3, new THREE.Vector3(-0.5, 0, -0.2), 0.06, 0.5, 1.9);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
