...
function Terrestrials () {
  ...
  terrestrial = new Terrestrial(this, 2, new THREE.Vector3(0.3, 0, -0.1).add(this.raceMesh.position), 0.08);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  var terrestrial = new Terrestrial(this, 1, new THREE.Vector3(0, 0, -0.4).add(this.raceMesh.position), 0.1);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
