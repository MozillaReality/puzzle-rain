...
function Terrestrials () {
  ...
  terrestrial = new Terrestrial(this, 1, new THREE.Vector3(0, 0.5, 1.1), 0.06);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  var terrestrial = new Terrestrial(this, 2, new THREE.Vector3(-0.5, 0.6, 0.8), 0.075);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  terrestrial = new Terrestrial(this, 3, new THREE.Vector3(-0.8, 0.5, 0.55), 0.09);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
}
