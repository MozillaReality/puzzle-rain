...
function Terrestrials () {
  ...
  terrestrial = new Terrestrial(this, 2, new THREE.Vector3(0.3, 0, -0.1), 0.08);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  var terrestrial = new Terrestrial(this, 1, new THREE.Vector3(0, 0, -0.4), 0.1);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
  terrestrial = new Terrestrial(this, 3, new THREE.Vector3(-0.3, 0, -0.6), 0.06);
  this.creaturesArr.push(terrestrial);
  this.add(terrestrial);
