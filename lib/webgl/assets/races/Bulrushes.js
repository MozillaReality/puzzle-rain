...
function Bulrushes () {
  ...
  var bulrush = new Bulrush(this, 1, new THREE.Vector3(0, 0.8, 0.4).add(this.raceMesh.position), 0.09);
  this.creaturesArr.push(bulrush);
  this.add(bulrush);
  bulrush = new Bulrush(this, 2, new THREE.Vector3(0.3, 0.7, -0.2).add(this.raceMesh.position), 0.07);
  this.creaturesArr.push(bulrush);
  this.add(bulrush);
}
