...
function Bouncers () {
  ...
  bouncer = new Bouncer(this, 1, new THREE.Vector3(-0.4, 0.25, 0.3).add(this.raceMesh.position), 0.075);
  ...
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  bouncer = new Bouncer(this, 4, new THREE.Vector3(0.5, 0.15, 0.25).add(this.raceMesh.position), 0.07);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
