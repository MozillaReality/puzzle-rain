...
console.log(THREE.TextureLoader.prototype.crossOrigin);
...
function Bouncers () {
  ...
  this.emitter.setTranslation(this.raceMesh.position.x, this.raceMesh.position.y, this.raceMesh.position.z - 0.5);

  bouncer = new Bouncer(this, 1, new THREE.Vector3(-0.4, 0.5, 0.3).add(this.raceMesh.position), 0.075);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  var bouncer = new Bouncer(this, 3, new THREE.Vector3(-0.1, 0.4, 0.15).add(this.raceMesh.position), 0.1);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  bouncer = new Bouncer(this, 2, new THREE.Vector3(0.2, 0.45, 0.2).add(this.raceMesh.position), 0.08);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  bouncer = new Bouncer(this, 4, new THREE.Vector3(0.5, 0.35, 0.25).add(this.raceMesh.position), 0.07);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
