...
function Bouncers (pos) {
  ...
  this.add(bouncer);
  bouncer = new Bouncer(new THREE.Vector3(0.2, 1, 0.2), 0.1);
  this.add(bouncer);
  bouncer = new Bouncer(new THREE.Vector3(-0.2, 1.5, 0.1), 0.1);
  this.add(bouncer);
  bouncer = new Bouncer(new THREE.Vector3(0.3, 0.5, -0.3), 0.3);
  this.add(bouncer);
}
