...
function Bouncers (pos) {
  ...
  this.add(bouncer);
  bouncer = new Bouncer(this, 2, new THREE.Vector3(0.2, 0.8, 0.2), 0.08, 0.4, 2);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  bouncer = new Bouncer(this, 3, new THREE.Vector3(-0.2, 1, 0.1), 0.05, 0.5, 1.9);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  bouncer = new Bouncer(this, 4, new THREE.Vector3(0.3, 0.5, -0.3), 0.065, 0.3, 2);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
