...
function Bouncers () {
  ...
  bouncer = new Bouncer(this, 1, new THREE.Vector3(-0.4, 0.25, -0.1), 0.05);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  var bouncer = new Bouncer(this, 3, new THREE.Vector3(-0.1, 0.2, -0.15), 0.1);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  bouncer = new Bouncer(this, 2, new THREE.Vector3(0.2, 0.25, -0.2), 0.08);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
  bouncer = new Bouncer(this, 4, new THREE.Vector3(0.4, 0.15, -0.1), 0.065);
  this.creaturesArr.push(bouncer);
  this.add(bouncer);
