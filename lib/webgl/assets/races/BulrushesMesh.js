...
function BulrushesMesh (obj) {
  ...
  var self = this;
  this.mesh.load('models/races/bulrushes.json', function () {
    ...
    self.mesh.material = new THREE.MeshStandardMaterial({
      ...
      roughness: 1,
      metalness: 0,
      emissive: new THREE.Color(0x39b620),
      emissiveIntensity: 0,
    ...
    // self.mesh.material.emissive = new THREE.Color(0x39b620);
    // self.mesh.material.emissiveIntensity = 0.05;
...
BulrushesMesh.prototype = Object.create(THREE.Object3D.prototype);

BulrushesMesh.prototype.update = function (delta) {
  ...
  this.scale.y = 1 + this.clampedIntensity;
