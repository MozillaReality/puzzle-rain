...
function Flyers () {
  ...
  this.emitter.setTranslation(this.raceMesh.position.x + 0.1, this.raceMesh.position.y, this.raceMesh.position.z + 0.1);

  var flyer = new Flyer(this, 1, new THREE.Vector3(-0.1, 0.2, -0.3).add(this.raceMesh.position), 0.08);
