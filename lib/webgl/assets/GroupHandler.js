...
function GroupHandler (raceObj, radius, color, idAudio, minHeight, maxHeight) {
  ...
  this.glowObj.scale.set(1.1, 1.1, 1.1);
...
GroupHandler.prototype.update = function (delta, time) {
  ...
  var scaleVolume = THREE.Math.mapLinear(this.track.averageAnalyser, 0, 100, 1.5, 3);
  ...
  if (this.handGrabbed !== '') {
    ...
    var newPosition = this.position.y - 0.0002;
...
GroupHandler.prototype.rollOver = function () {
  if (this.overStatus !== 'over') {
    ...
    this.glowObj.scale.set(1.3, 1.3, 1.3);
...
GroupHandler.prototype.magicDispatched = function (side, race) {
...
GroupHandler.prototype.clampPositionY = function (pos) {
