...
Terrestrial.prototype.init = function () {
  ...
  this.body = new CANNON.Body({
    ...
    collisionFilterGroup: CannonManager.groupTerrestrials, // Put in group
    collisionFilterMask: CannonManager.groupGround | CannonManager.groupTerrestrials | CannonManager.groupBouncers // It can only collide with
  });
