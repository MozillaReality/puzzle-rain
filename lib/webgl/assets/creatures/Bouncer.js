...
function Bouncer (race, index, pos, scale, minHeight, maxHeight) {
  ...
  this.material = new THREE.MeshStandardMaterial({color: 0x39393c, roughness: 1, metalness: 0.5, emissive: this.originalColor, emissiveIntensity: 0, shading: THREE.FlatShading});
