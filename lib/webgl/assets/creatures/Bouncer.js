...
function Bouncer (race, index, pos, scale) {
  Creature.call(this, race, index, pos, scale);

  var objectLoader = new THREE.ObjectLoader();
  var self = this;
  objectLoader.load('models/creatures/bouncer.json', function (obj) {
    obj.children.forEach(function (value) {
      if (value instanceof THREE.Mesh) {
        ...
        self.bodyMesh.name = 'bouncer_' + index;
        self.bodyMesh.receiveShadow = true;
        self.bodyMesh.castShadow = true;

        self.eyes.position.set(0, 0.6, 0.5);
        self.mouth.position.set(0, 0.25, 0.78);
