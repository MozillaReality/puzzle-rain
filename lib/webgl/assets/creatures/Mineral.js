...
function Mineral (race, index, pos, scale, minHeight, maxHeight) {
  ...
  var material = new THREE.MeshStandardMaterial({color: 0x39393c, roughness: 0.5, metalness: 0.5, emissive: this.originalColor, emissiveIntensity: 0, shading: THREE.FlatShading});
