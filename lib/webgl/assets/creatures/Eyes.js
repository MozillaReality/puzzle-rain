...
function Eye (size, eye, eyelidColor) {
  ...
  this.eyeballMaterial = new THREE.MeshStandardMaterial({color: 0x39393c, roughness: 1, metalness: 0, emissive: 0xffffff, emissiveIntensity: 0, transparent: true, shading: THREE.FlatShading});
