...
Arrive.prototype.isInfluencedByHands = function () {
  ...
  if (this.target0 !== undefined && this.target0.influencedRace === this.raceToControl.name) {
    influenced = true;
  }
  if (this.target1 !== undefined && this.target1.influencedRace === this.raceToControl.name) {
    influenced = true;
  }
  return influenced;
};
...
Arrive.prototype.getTargetPosition = function () {
  ...
  var target = this.raceToControl.speaker.position.clone().sub(this.raceToControl.position);
  ...
  if (this.target0 !== undefined && this.target0.influencedRace === this.raceToControl.name && this.target1 !== undefined && this.target1.influencedRace === this.raceToControl.name) {
    // Mid point
