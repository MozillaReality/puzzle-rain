...
Arrive.prototype.getTargetPosition = function () {
  ...
  if (this.target0 !== undefined && this.target0.influencedRace === this.raceToControl && this.target0.lastPressed && !this.target0.isGrabbed) {
    target = this.target0.position.clone().sub(this.raceToControl.position);
  }
  if (this.target1 !== undefined && this.target1.influencedRace === this.raceToControl && this.target1.lastPressed && !this.target1.isGrabbed) {
    target = this.target1.position.clone().sub(this.raceToControl.position);
  }
  if (this.target0 !== undefined && this.target0.influencedRace === this.raceToControl && this.target0.lastPressed && !this.target0.isGrabbed && this.target1 !== undefined && this.target1.influencedRace === this.raceToControl && this.target1.lastPressed && !this.target1.isGrabbed) {
    // Mid point
