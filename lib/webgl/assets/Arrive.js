...
Arrive.prototype.getTargetPosition = function () {
  ...
  if (this.target0 !== undefined && this.target0.influencedRace === this.raceToControl && this.target0.lastPressed && this.target1 !== undefined && this.target1.influencedRace === this.raceToControl && this.target1.lastPressed) {
    // Mid point
