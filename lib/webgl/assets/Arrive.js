...
function Arrive (obj) {
  ...
  if (settings.debugHelpers) {
    this.helper = new THREE.Mesh(
      ...
      new THREE.MeshBasicMaterial({ color: settings[this.obj.race.name + 'Color']})
    );
...
Arrive.prototype.isInfluencedByHands = function () {
  ...
  if (this.target0 !== undefined && this.target0.influencedRace === this.obj.race) {
    influenced = true;
  }
  if (this.target1 !== undefined && this.target1.influencedRace === this.obj.race) {
    influenced = true;
  }
  return influenced;
};
...
Arrive.prototype.getTargetPosition = function () {
  ...
  if (this.target0 !== undefined && this.target0.influencedRace === this.obj.race && this.target1 !== undefined && this.target1.influencedRace === this.obj.race) {
    // Mid point
