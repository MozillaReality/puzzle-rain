...
Ground.prototype.fadeToEnd = function () {
  ...
  var material = new THREE.MeshBasicMaterial({side: THREE.BackSide, transparent: true, opacity: 0});
...
Ground.prototype.closerEnding = function () {
  this.track.setStartTime(this.timeAtEnding - 10);
  this.counter = this.timeAtEnding - 10;
};
