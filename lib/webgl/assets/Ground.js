...
Ground.prototype.update = function (delta, time) {
  ...
  if (this.isGroundFading) {
    this.worldFar.material.color = new THREE.Color(MathUtils.blendColors(0x666666, 0xe03b5c, this.sunrise));
    ...
    this.shell.material.emissive = new THREE.Color(MathUtils.blendColors(0x666666, 0xe03b5c, this.sunrise));
