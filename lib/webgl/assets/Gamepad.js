...
function Gamepad (hand) {
  ...
  this.mesh.load('models/hand' + this.side + '.json', function () {
    ...
    self.mesh.material.emissive = new THREE.Color(0xffffff);
    self.mesh.material.emissiveIntensity = 0.5;
...
Gamepad.prototype.activeHandlerDispatch = function (side, obj) {
  if (side === this.side) {
    ...
    if (obj === null) {
      ...
      this.mesh.material.emissiveIntensity = 0.75;
    }
  }
};
...
Gamepad.prototype.grabHandler = function () {
  ...
  // TODO prevent shadow & transparent bug if is visible but with opacity 0
