...
Gamepad.prototype.introBallCollided = function (side) {
  if ('hapticActuators' in this.gamepadVive && this.gamepadVive.hapticActuators.length > 0 && this.side === side) {
...
Gamepad.prototype.stageChanged = function (newStage) {
  switch (newStage) {
    case 'ending':
      if ('hapticActuators' in this.gamepadVive && this.gamepadVive.hapticActuators.length > 0) {
