...
Gamepad.prototype.introBallCollided = function (side) {
  if (this.gamepadVive && 'haptics' in this.gamepadVive && this.gamepadVive.haptics.length > 0 && this.side === side) {
    this.gamepadVive.haptics[0].vibrate(1, 100);
  }
  if (this.gamepadVive && 'hapticActuators' in this.gamepadVive && this.gamepadVive.hapticActuators.length > 0 && this.side === side) {
    this.gamepadVive.hapticActuators[0].pulse(1, 100);
  }
};
...
Gamepad.prototype.introBallCatched = function () {
  ...
  if (this.gamepadVive && 'haptics' in this.gamepadVive && this.gamepadVive.haptics.length > 0) {
    this.gamepadVive.haptics[0].vibrate(1, 500);
  }
  if (this.gamepadVive && 'hapticActuators' in this.gamepadVive && this.gamepadVive.hapticActuators.length > 0) {
    this.gamepadVive.hapticActuators[0].pulse(1, 500);
  }
...
Gamepad.prototype.stageChanged = function (newStage) {
  switch (newStage) {
    case 'ending':
      if (this.gamepadVive && 'haptics' in this.gamepadVive && this.gamepadVive.haptics.length > 0) {
        this.gamepadVive.haptics[0].vibrate(1, 1000);
      }
      if (this.gamepadVive && 'hapticActuators' in this.gamepadVive && this.gamepadVive.hapticActuators.length > 0) {
        this.gamepadVive.hapticActuators[0].pulse(1, 1000);
      }
      this.dropHandler();
      break;
  }
