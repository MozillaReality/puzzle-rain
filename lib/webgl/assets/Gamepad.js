...
var MagnetCircles = require('./MagnetCircles');
...
function Gamepad (hand) {
  ...
  this.mesh.load('models/hand' + this.side + '.json', function () {
    ...
    Events.on('activeCreatureChanged', self.activeCreatureChanged.bind(self));
...
Gamepad.prototype.addMagnetCircles = function () {
  this.magnetCircles = new MagnetCircles(this);
  this.add(this.magnetCircles);
};
...
Gamepad.prototype.activeCreatureChanged = function (side, creature) {
  // if (this.side === side && this.influencedCreature !== creature) {
  //   this.influencedCreature = creature;
  // }
};
