...
Gamepad.prototype.introBallStarted = function (delta) {
  var self = this;
  this.handTween = new TWEEN.Tween(this.mesh.material).to({
...
Gamepad.prototype.introBallCatched = function () {
  ...
  this.handTween2 = new TWEEN.Tween(this.mesh.material).to({
...
Gamepad.prototype.manageButtons = function (buttonId, intensity, isPressed) {
  ...
  console.log('remove activate ending in production');
  if (buttonId === 2) {
