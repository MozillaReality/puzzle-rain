...
var VolumeLight = require('./VolumeLight');
...
Gamepad.prototype.playAnimation = function (animation, isPressed) {
  ...
  if (animation === 'pointing') {
    this.volumeLight.intensity = isPressed;
  }
};
...
Gamepad.prototype.addVolumeLight = function () {
  this.volumeLight = new VolumeLight();
  this.scene.add(this.volumeLight);
};
