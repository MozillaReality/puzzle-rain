...
function Creature (race, index, myPos, myScale) {
  ...
  this.dotPos = new THREE.Vector3(this.pos.x * 1.15, 1 + Math.random() * 0.3, this.pos.z * 1.15);
...
Creature.prototype.switchPos = function (otherCreature) {
  this.returnPos.set(otherCreature.pos.x, otherCreature.pos.y, otherCreature.pos.z);
  this.position.set(otherCreature.pos.x, otherCreature.pos.y, otherCreature.pos.z);
