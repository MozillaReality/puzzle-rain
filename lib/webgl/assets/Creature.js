...
Creature.prototype.happyDispatched = function (mesh) {
  if (mesh === this.mesh) {
    if (this.raceObj.status === 'awake' && this.status !== 'happy' && this.status !== 'upset') {
      ...
      this.hiding = setTimeout(this.makeNormal.bind(this), 1000);
...
Creature.prototype.collisionDispatched = function (mesh, side, point) {
  if (mesh === this.mesh) {
    if (this.status !== 'upset' || this.status !== 'happy') {
