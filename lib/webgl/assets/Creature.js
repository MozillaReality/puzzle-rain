...
function Creature (raceObj, groupHandler, index, myPos, myScale) {
...
Creature.prototype.update = function (delta, time) {
  ...
  if (this.groupHandler.track) {
    this.mouth.scale.y = THREE.Math.mapLinear(this.groupHandler.track.averageAnalyser * this.groupHandler.track.getVolume(), 0, 100, 1, 35);
  }
};
