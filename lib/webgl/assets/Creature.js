...
Creature.prototype.updateCommon = function (delta, time) {
  ...
  // TODO set volume depending on position respect hand or x= 0, z = 0...
  // this.track.setVolume();
  // TODO more or less emissive depending on volume
...
Creature.prototype.wakeOver = function () {
  this.bodyMesh.material.opacity = 1;
  tweenEmissive('mouth', this.mouth.mesh.material, 1, 500 + this.wakeRand, 'out');
  tweenEmissive('leftEye', this.eyes.left.eyeball.material, 1, 500 + this.wakeRand, 'out');
  tweenEmissive('rightEye', this.eyes.right.eyeball.material, 1, 500 + this.wakeRand, 'out');
  new TWEEN.Tween(this.eyes.right.eyeball.material).to({
    opacity: 1
  }, 500)
    .easing(TWEEN.Easing.Cubic.Out)
...
Creature.prototype.wakeOut = function () {
  tweenEmissive('mouth', this.mouth.mesh.material, 0, 1000 + this.wakeRand, 'in');
  tweenEmissive('leftEye', this.eyes.left.eyeball.material, 0, 1000 + this.wakeRand, 'in');
  tweenEmissive('rightEye', this.eyes.right.eyeball.material, 0, 1000 + this.wakeRand, 'in');
  new TWEEN.Tween(this.eyes.right.eyeball.material).to({
    opacity: 0
  }, 500)
    .easing(TWEEN.Easing.Cubic.In)
