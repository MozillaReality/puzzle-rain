...
function Speaker (obj) {
  ...
  THREE.Mesh.call(this, new THREE.BoxBufferGeometry(0.05, 0.05, 0.05), new THREE.MeshBasicMaterial({ color: settings[this.obj.race + 'Color'], transparent: true, opacity: 0}));
