...
function Cracks () {
  ...
  var material = new THREE.MeshBasicMaterial({ color: 0x39b620, blending: THREE.MultiplyBlending });
  ...
  geometry.rotateX(- Math.PI / 2);
  var material = new THREE.MeshBasicMaterial({ color: 0xC9CC1E, blending: THREE.MultiplyBlending });
  ...
  geometry.rotateX(- Math.PI / 2);
  var material = new THREE.MeshBasicMaterial({ color: 0x9E3F36, blending: THREE.MultiplyBlending });
  crack = new THREE.Mesh(geometry, material);
  crack.scale.set(0.05, 0.05, 0.05);
  ...
  geometry.rotateX(- Math.PI / 2);
  var material = new THREE.MeshBasicMaterial({ color: 0x035688, blending: THREE.MultiplyBlending });
  crack = new THREE.Mesh(geometry, material);
  crack.scale.set(0.05, 0.05, 0.05);
...
Cracks.prototype.startEnd = function () {
