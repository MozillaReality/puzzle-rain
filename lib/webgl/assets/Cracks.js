...
Cracks.prototype.stageChanged = function (newStage) {
  if (newStage === 'ending' && State.get('endMode') === 2) {
    tween(this.cracksArr[0].scale, 18000, 2000 + Math.random() * 2000);
    tween(this.cracksArr[1].scale, 20000, 2000 + Math.random() * 2000);
    tween(this.cracksArr[2].scale, 19000, 2000 + Math.random() * 2000);
    tween(this.cracksArr[3].scale, 17000, 2000 + Math.random() * 2000);
  }
};
