...
Arrive.prototype.getTargetPosition = function () {
  ...
  if (this.target0 !== undefined && this.target0.activeRace.value === this.race) {
    target = this.target0.position;
  }
  if (this.target1 !== undefined && this.target1.activeRace.value === this.race) {
    target = this.target1.position;
  }
  if (this.target0 !== undefined && this.target0.activeRace.value === this.race && this.target1 !== undefined && this.target1.activeRace.value === this.race) {
    // Mid point
