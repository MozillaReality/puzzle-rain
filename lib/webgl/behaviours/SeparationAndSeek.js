...
SeparationAndSeek.prototype.separate = function (vehicles) {
  ...
  for ( var i = 0; i < vehicles.length; i++) {
    ...
    var myPos2D = new THREE.Vector3(this.obj.position.x + this.obj.parent.position.x, posY, this.obj.position.z + + this.obj.parent.position.z);
    var posVehicleY = 0;
    if (this.dimensions === 3) {
      posVehicleY = vehicles[ i ].position.y;
    }
    var vehiclePos2D = new THREE.Vector3(vehicles[ i ].position.x, posVehicleY, vehicles[ i ].position.z);
