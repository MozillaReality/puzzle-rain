...
var rendererSpectator = require('./RendererSpectator');
...
var sky, ground, introBall, superHead, cracks, endCredits;
var crowd;
...
function App () {
  ...
  function hideAll () {
    ...
    setTimeout(function () {
      superHead.position.y = -1000;
    }, 300);
    setTimeout(function () {
      cracks.position.y = -1000;
    }, 400);
    // setTimeout(function () {
    //   keyLight.position.y = -1000;
    // }, 500);
    // setTimeout(function () {
    //   fillLight.position.y = -1000;
    // }, 600);
    setTimeout(function () {
      gamepadR.position.y = -1000;
    }, 700);
    setTimeout(function () {
      gamepadL.position.y = -1000;
    }, 800);
    setTimeout(function () {
      introBall.position.y = -1000;
    }, 900);
  // sky.position.y = -1000;
  // ground.position.y = -1000;
  // superHead.position.y = -1000;
  ...
  function render () {
    ...
    if (settings.trailerMode) {
      rendererSpectator.render(scene, camera);
    }
    if (vrMode) {
