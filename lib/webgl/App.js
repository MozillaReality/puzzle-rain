...
var SecureArea = require('./assets/SecureArea');

var GamepadDummy = require('./assets/GamepadDummy');

var GamepadsManager = require('./managers/GamepadsManager');

var sky, ground, gamepads, gamepadDummy, crowd;

var Crowd = require('./assets/Crowd');
...
function App () {
  function init () {
    ...
    var light = new THREE.PointLight(0xf4f4f4, 0.4, 0);
  ...
  function vrFallback () {
    ...
    // secureArea.receiveShadow = true;
    scene.add(secureArea);
    gamepadDummy = new GamepadDummy(scene);
