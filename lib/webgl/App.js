...
const ContactMaterialsManager = require('./managers/ContactMaterialsManager');

const Crowd = require('./assets/Crowd');

let world, cannonDebugRenderer, crowd, contactMaterialsManager;
let lastCallTime = 0,
  resetCallTime = false;
...
function App () {
  function init () {
    ...
    contactMaterialsManager = new ContactMaterialsManager(world);
    // CONTROLS
