...
var CannonDebugRenderer = require('./utils/CannonDebugRenderer');
...
function App () {
  function init (spectatorMode) {
    ...
    if (navigator.getVRDisplays || navigator.getVRDevices) {
      ...
      console.log('Waiting to detect a VR display connected...');
    } else {
      vrFallback();
      addObjects();
    }
