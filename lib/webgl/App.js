...
var GroupCreaturesLight = require('./assets/GroupCreaturesLight');

var groupCreaturesLightR, groupCreaturesLightL;
...
function App () {
  function init () {
    ...
    scene.fog = new THREE.Fog(0x444444, 0, 65);
  ...
  function addControllers () {
    ...
    groupCreaturesLightR = new GroupCreaturesLight('R');
    scene.add(groupCreaturesLightR);
    groupCreaturesLightL = new GroupCreaturesLight('L');
    scene.add(groupCreaturesLightL);
  }
