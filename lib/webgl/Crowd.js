...
Crowd.prototype.addCreatures = function () {
  var bouncers = new Bouncers(new THREE.Vector3(0.384, 0, -1.828));
  this.scene.add(bouncers);
  var bulrushes = new Bulrushes(new THREE.Vector3(-1.063, 0, -0.649));
  this.scene.add(bulrushes);
  var flyers = new Flyers(new THREE.Vector3(0.897, 0, 0.987));
  this.scene.add(flyers);
  var minerals = new Minerals(new THREE.Vector3(1.51, 0, -0.66));
  this.scene.add(minerals);
  var terrestrials = new Terrestrials(new THREE.Vector3(-0.606, 0, 0.912));
